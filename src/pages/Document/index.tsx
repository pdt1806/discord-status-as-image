  ...
  return (
    <Container mt="xl" mb="xl">
      <Helmet>
        ...
        <link rel="canonical" href={`https://disi.fyi/${document.title.toLowerCase().replaceAll(" ", "-")}`} />
      </Helmet>
      <Paper shadow="xl" p="xl" bg="#1a1a1a">
        <Box m="lg">
          ...
          <Text mb="sm">
            ...
            {monthsKey[document.created.slice(5, 7) as keyof typeof monthsKey]}, {document.created.slice(0, 4)}
          </Text>
          <Text mb="xl">
            Last Updated: {document.updated.slice(8, 10)}{" "}
            {monthsKey[document.updated.slice(5, 7) as keyof typeof monthsKey]}, {document.updated.slice(0, 4)}
          </Text>
          <Box
