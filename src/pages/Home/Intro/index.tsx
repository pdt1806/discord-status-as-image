    ...
    <Center display="flex" style={{ flexDirection: "column" }}>
        ...
        <Overlay h="auto" mt="xl" mb="md" radius="md" p="lg">
          <Flex align="center" direction="column" justify="center" h="100%">
            ...
            <Text mb="xl" ta="center" maw="75%">
              Turn your Discord status into a simple, eye-catching image for easy sharing and display. With your
              username and just a few clicks, setting things up is quick and easy!
            </Text>
          </Flex>
        </Overlay>
        <Image src="/images/showcase/disi-showcase-1.webp" mih={500} h="auto" mt="xl" mb="md" radius="md" />
      </Box>
      <Flex align="center" mb="xl" direction={isMobile ? "column" : "row"} w="80%">
        <Box w={isMobile ? "100%" : "45%"}>
          ...
          <Text>
            You can easily embed the image into your website or markdown file, and your Discord status will be shown and
            updated automatically for people who are not yet your friends. Moreover, they can click on the image and
            send you a friend request.
          </Text>
        </Box>
        <Image
          src="/images/showcase/disi-showcase-2.webp"
          w={isMobile ? "100%" : "50%"}
