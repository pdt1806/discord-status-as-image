...
export function updateStatus({
  ...
  setAvatarDecoration: (avatarDecoration: string) => void;
  setPrimaryGuild: (primaryGuild: PrimaryGuildType) => void;
  ...
  return fetch(url, {
    ...
    .then((res) => res.json())
    .then(async (data: RefinerResponse) => {
